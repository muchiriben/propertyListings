...
<a href="{{route('agents.properties.edit', $property->property_id)}}" class="btn btn-primary">Edit</a>

<!--delete property -->
{!!Form::open(['action' => ['Agents\PropertiesController@destroy', $property->property_id] , 'method' => 'POST', 'class' => 'float-right'])!!}
