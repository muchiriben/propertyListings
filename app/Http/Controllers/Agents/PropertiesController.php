...
class PropertiesController extends Controller
{
    ...
    public function index()
    {
        ...
        $properties = Property::where('agent_id', $agent_id)
               ...
               ->paginate(5);
        return view('agents.properties.index')->with('properties', $properties);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('agents.properties.index')->with('success', 'Listing Created');
    }
    ...
    {
        return view('agents.properties.show')->with('property', $property);
    }
    ...
    {
        return view('agents.properties.edit')->with('property', $property);
    }
    ...
    public function update(Request $request, Property $property)
    {
        ...
        return redirect('agents/properties')->with('success', 'Property Updated');
    }
    ...
    public function destroy(Property $property)
    {
        ...
        $property->delete();
        return redirect('agents/properties')->with('success', 'Property Deleted');
    }
}
